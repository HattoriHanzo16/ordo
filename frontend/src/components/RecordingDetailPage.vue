  ...
  <div class="min-h-screen bg-secondary-50">
    ...
    <main class="container mx-auto px-4 py-8">
      ...
      <div v-else-if="recording" class="space-y-8">
        ...
        <!-- Processing State -->
        <div v-else-if="recording.processing_status === 'processing'" class="bg-blue-50 border border-blue-200 rounded-xl p-6">
          <div class="flex items-center">
            ...
            <div>
              <h3 class="text-lg font-semibold text-blue-800 mb-1">Processing in Progress</h3>
              <p class="text-blue-700">Your recording is being transcribed and analyzed. Please check back in a few minutes.</p>
            </div>
          </div>
        </div>
        ...
        <div v-else class="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div class="xl:col-span-2 space-y-6">
            ...
            <!-- Action Items -->
            <div v-if="recording.action_items && recording.action_items.length" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2 class="text-xl font-semibold text-dark-900 mb-4 flex items-center">
                <svg class="w-6 h-6 text-orange-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                </svg>
                Action Items
                <span class="ml-2 text-sm bg-orange-100 text-orange-800 px-2 py-1 rounded-full">{{ recording.action_items.length }}</span>
              </h2>
              <div class="space-y-3">
            ...
            <!-- Decisions -->
            <div v-if="recording.decisions && recording.decisions.length" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h2 class="text-xl font-semibold text-dark-900 mb-4 flex items-center">
